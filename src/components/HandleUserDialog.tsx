      ...
      <form>
        <DialogTrigger asChild>
          {action === 'edit' ? (
            ...
            <Button 
              variant="default" 
              className='cursor-pointer bg-[#8B5CF6]'
            >
              {label}
            </Button>
          )}
        ...
        <DialogContent className="sm:max-w-106.25">
          ...
          <div className="grid gap-4">
            ...
            <div className="grid gap-3">
              ...
              <Input id="avatar" name="avatar" placeholder='ingresa la url de la imagen' ref={imageRef} />
            </div>
          </div>
          <DialogFooter>
            <DialogClose asChild>
            ...
            <DialogClose asChild>
              <Button type='submit' onClick={handleCreateUser}>{label}</Button>
            </DialogClose>
          </DialogFooter>
        </DialogContent>
      </form>
